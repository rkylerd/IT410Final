...
export default {
    ...
    data() {
        return {
            ...
            loading: false,
            shippingPrice: 0,
            fname: this.$store.getters['user'].fName,
            lname: this.$store.getters['user'].lName,
            phone: this.$store.getters['user'].phone,
            email: this.$store.getters['user'].email,
            street1: this.$store.getters['user'].addresses[0].street1,
            street2: this.$store.getters['user'].addresses[0].street2,
            city: this.$store.getters['user'].addresses[0].city,
            zip: this.$store.getters['user'].addresses[0].zip,
            state: this.$store.getters['user'].addresses[0].state || null,
            options: [
